...
## code
```
Name: <h1>ExpNo 1 : Implement Depth First Search Traversal of a Graph</h1> 
...
<h3>Result:</h3>
<hr>
<p>Thus,a Graph was constructed and implementation of Depth First Search for the same graph was done successfully.</p> Navya 
